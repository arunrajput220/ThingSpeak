...
String apiKey = "1M9LVNVD3G8AT702";     //  Enter your Write API key from ThingSpeak

const char *ssid =  "Notforyou";     // replace with your wifi ssid and wpa2 key
const char *pass =  "AGRAbangalore";
